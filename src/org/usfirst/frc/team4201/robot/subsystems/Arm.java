...
public class Arm extends PIDSubsystem {
	...
	public static double kPUp = kP;	
	public static double kDUp = kD;
	public static double kPDown = kPUp;
	public static double kDDown = kDUp;
	
	public static double angleLowerLimit = -61;																									// 1.5		
	public static double angleUpperLimit = 61;		// Physical limit is closer to 64, but 62 is to prevent DART from getting stuck at max extension	//11.5;		
	public static double angleOffset = 80;		
	public static double sensorLowerLimit = 0;																														
	public static double sensorUpperLimit = 105;																														
	public static double sensorOffset = -75.5;	

	public static double armHomeAngle = -60;
	public static double armSwitchAngle = -56;
	public static double armScaleAngle = 55;
