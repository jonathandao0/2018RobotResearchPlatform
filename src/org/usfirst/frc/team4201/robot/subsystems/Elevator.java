...
public class Elevator extends PIDSubsystem {
	...
	public static double kPLowUp = kP;
	public static double kILowUp = kI;
	public static double kDLowUp = kD;	
	...
	public static double hieghtLowerLimit = 3.775;			// -33
	public static double hieghtUpperLimit = 25;			//26.3			// 60
	public static double sensorLowerLimit = 0;
	public static double sensorUpperLimit = 52.6464;		// Adjusted, ideal is 50
