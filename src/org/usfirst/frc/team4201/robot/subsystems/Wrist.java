...
public class Wrist extends PIDSubsystem {
	public static double kP = 0.03;		// Test values for Triple Threat
	public static double kI = 0;
	public static double kD = 0.00;
	public static double kF = 0;
	public static double period = 0.01;
	
	public static double angleLowerLimit = -125;													// -75
	public static double angleUpperLimit = 150;													// 50 	
	public static double sensorLowerLimit = 0;														//-133;
	public static double sensorUpperLimit = -1080; 	// Negative value to 'invert' sensor		// 80; 
	public static double sensorOffset = 726; 			//431	//563;	//356								
	
	public static double armLimiterLowerBound = -46;
	public static double armLimiterUpperBound = 46;
	
	public static double wristRetractedAngle = 120;
	public static double wristNeutralScaleAngle = 90;
